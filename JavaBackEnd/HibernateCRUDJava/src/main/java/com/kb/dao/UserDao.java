...
public class UserDao {
	...
	public List<User> findUserByFirstName(String name) {
	        ...
	        try {
	            ...
	            TypedQuery<User> query = session.getNamedQuery("findUserByFirstName");    
	             query.setParameter("firstName1",name);   
	...
	//Read of CRUD
	@SuppressWarnings("unchecked")
	public List<User>findUserByLastNameAndAge(String lastName, int age)
	{
		List<User> users=new ArrayList<User>();
		Session session = HibernateUtil.getSessionFactory().openSession();
		try {
			TypedQuery<User> query = session.getNamedQuery("findUserByLastNameAndAge");
	...
	//Read of CRUD
	@SuppressWarnings("unchecked")
	public List<User>findUserByFirstNameAndEmail(String firstName , String email)
	{
		List<User> users=new ArrayList<User>();
		Session session = HibernateUtil.getSessionFactory().openSession();
		try
		{
			TypedQuery<User> query=session.getNamedQuery("findUserFirstNameAndEmail");
			query.setParameter("firstName1", firstName);
	...
	public List<User> findUserByLastName(String name) {
        ...
        try {
			...
			TypedQuery<User> query = session.getNamedQuery("findUserByLastName");    
             query.setParameter("lastName1",name);   
